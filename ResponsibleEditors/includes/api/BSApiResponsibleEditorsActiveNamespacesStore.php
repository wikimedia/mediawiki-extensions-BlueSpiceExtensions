<?php
/**
 * This class serves as a backend for the responsible editors activated namespaces
 * store.
 *
 ...
 */
class BSApiResponsibleEditorsActiveNamespacesStore extends BSApiExtJSStoreBase {
	/**
	...
	protected function makeData( $sQuery = '' ) {
		...
		$aActivatedNamespaces = BsConfig::get(
			'MW::ResponsibleEditors::ActivatedNamespaces'
		);
		foreach( $aActivatedNamespaces as $iNamespaceId ) {
			$aData[] = array(
				'namespace_id' => $iNamespaceId,
				'namespace_text' => BsNamespaceHelper::getNamespaceName(
					$iNamespaceId,
					true
				),
			);
