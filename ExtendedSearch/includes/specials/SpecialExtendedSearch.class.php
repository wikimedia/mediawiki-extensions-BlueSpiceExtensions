...
class SpecialExtendedSearch extends BsSpecialPage {
	 ...
	 * @var Object ExtendedSearchBaseMW class.
	 */
	...
	function __construct() {
		...
		$this->oExtendedsearchBase = ExtendedSearchBase::getInstance( 'MW' );
	}
	...
	public function renderExtendedForm( &$aMonitor ) {
		...
		$vOptionsFormWiki    = $vForm->getOptionsForm( 'wiki', wfMessage( 'bs-extendedsearch-search-wiki' )->plain() );
	...
	function execute( $sParameter ) {
		...
		$this->oUriBuilder    = new SearchUriBuilder( $this->oSearchOptions );
		$aMonitor             = array();
