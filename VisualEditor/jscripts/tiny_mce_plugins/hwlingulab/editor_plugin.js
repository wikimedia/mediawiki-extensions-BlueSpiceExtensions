	...
	init : function(ed, url) {
		...
		// Register buttons
				ed.addButton('hwlingulab', {
								...
								cmd : 'mceLingulab',
								image : wgScriptPath+'/extensions/BlueSpiceExtensions/VisualEditor/jscripts/tiny_mce/plugins/hwlingulab/images/icon.png'
						});
				ed.addCommand('mceLingulab', function(){
								...
								//console.log(text);
								$.ajax({
										url: wgScriptPath+"/extensions/BlueSpiceExtensions/VisualEditor/jscripts/tiny_mce/plugins/hwlingulab/src/sample_posteddata.php",
										type: "POST",
