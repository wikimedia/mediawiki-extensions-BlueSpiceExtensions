...
function() {
	...
	var _setLoading = function(flag) {
		...
		if( bsPermissionManagerRealityCheck ) {
	...
	var _gridExtra = bsPermissionManagerRealityCheck ? Ext.create('BS.PermissionManager.GridPanelExtra') : null;
	var _columnsHiddenDefault = {};
	var _extraStore = bsPermissionManagerRealityCheck ? Ext.create('Ext.data.Store', {
